...
An HTML-first, reproducible nine-scene motion-graphics project for **WiCompass: Oracle-driven Data Scaling for mmWave Human Pose Estimation**. The current cut is 82.6 seconds and follows a Question → Insight → Mechanism → Evidence → Vision narrative.
...
Render one scene at normal animation speed instead of replaying the full 82.6-second cut:
