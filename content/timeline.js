const sceneDefinitions = [
  ...
  },
  {
    ...
    duration: 9,
    stillOffset: 4.5,
    caption: "On mmBody, keeping thirty percent of the frames leaves error near sixty-eight millimeters. More data is not more coverage.",
    voiceover: "On mmBody, keeping thirty percent of the frames leaves error near sixty-eight millimeters. More data is not more coverage.",
  },
  {
    id: "method",
    duration: 13,
  ...
  },
  {
    ...
    duration: 10.5,
    stillOffset: 5.5,
    caption: "With the same model and budget, fitted scaling laws remain twenty-five to thirty millimeters apart from two thousand to forty thousand samples.",
    voiceover: "With the same model and budget, fitted scaling laws remain twenty-five to thirty millimeters apart from two thousand to forty thousand samples.",
  },
  {
    id: "realworld",
    duration: 10.6,
